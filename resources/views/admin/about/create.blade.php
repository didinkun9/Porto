    ...
    <div class="card-body">
        <form method="POST" action="{{ route('about.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control @error('github') is-invalid @enderror" name="github" id="github" type="">
                @error('github')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control @error('birthday') is-invalid @enderror" name="birthday" id="birthday" type="date">
                @error('birthday')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
