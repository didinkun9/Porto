...
<body id="page-top">
 <!-- <audio autoplay="true" loop="true">
    <source src="storage/uploads/audio/Music.mp3" type="audio/mp3">
  </audio> -->
        ...
        <div class="intro-content display-table">
            <div class="table-cell">
                <div class="container">
                    ...
                    <h1 class="intro-title mb-4">{{ $getHeader->up_text ?? 'I am Didin Anandi' }}</h1>
                    <p class="intro-subtitle"><span
                            class="text-slider-items">{{ $getHeader->down_text ?? 'Iam a Web Developer' }}</span><strong
                            ...
                            <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-7">
                                            <div class="about-info">
                                                <p><span class="title-s">Name: </span>
                                                    <span>{{ $getAbout->name ?? 'Didin Anandi' }}</span></p>
                                                <p><span class="title-s">Profile: </span>
                                                    <span>{{ $getAbout->role ?? 'Profesional Programmer' }}</span></p>
                                                <p><span class="title-s">GitHub Account: </span>
                                                    <span>{{ $getAbout->github ?? 'https://github.com/didinkun9/' }}</span></p>
                                                <p><span class="title-s">birthday: </span>
                                                    <span>{{ $getAbout->birthday ?? '1997-01-15' }}</span></p>
                                            </div>
                                        </div>
                                    </div>
                                    @if ($getSkill->count() > 0)
                                ...
                                <div class="col-md-6">
                                    <div class="about-me pt-4 pt-md-0">
                                        ...
                                        <p class="lead">
                                            {{ $getAbout->description ?? 'Iam a Profesional Web Developer' }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="socials">
                                            <ul>
                                                <li><a href="javascript:void(0)"
                                                        onclick="window.open('https://www.linkedin.com/in/didin-anandi-71b351259/')"><span
                                                            class="ico-circle"><i
